...
//  
//
//  Created by Shanezzar Sharon on 06/08/2021.
//
...
public struct CountryCodes : View {
    ...
    let country = ["AF":"93","AL":"355","DZ":"213","US":"1",
    ...
    public var body: some View {
        GeometryReader { geo in
                    ...
                    VStack {
                        ForEach(alphabet, id: \.self) { letter in
                            Section(header: HStack {
                                ...
                                ForEach(country.sorted(by: <).filter { countryName(countryCode: $0.key)!.hasPrefix(letter) }, id: \.key) { key, value in
                                    HStack {
                                        ...
                                        Text("+\(value)").foregroundColor(.secondary)
                                            .foregroundColor(countryColor.opacity(0.8))
                                            .font(countryFont)
                                    }
                                    .onTapGesture {
            ...
            .position(x: geo.size.width/2, y: geo.frame(in: .global).maxY - height/2)
